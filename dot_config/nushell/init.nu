...
def "setup hyprland" [command: string@[
  ...
  if $command == "apt" {
    sudo apt install hyprland kitty waybar wofi fonts-font-awesome xdg-desktop-portal-hyprland cliphist wl-clipboard hyprland-qtutils hyprlauncher mako-notifier slurp grim wireplumber hyprpaper hyprlock hyprshutdown
  } else {
